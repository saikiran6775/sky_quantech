...
<span class="gps-ping absolute w-16 h-16 rounded-[9999px] bg-accent-blue/40"></span>
<span class="gps-ping gps-ping-delayed absolute w-16 h-16 rounded-[9999px] bg-accent-blue/40"></span>
<img class="gps-pin relative w-12 h-12 rounded-xl bg-white p-1 shadow-lg" src="assets/img/google-maps.jpg" alt="" width="192" height="192" loading="lazy" decoding="async"/>
</span>
